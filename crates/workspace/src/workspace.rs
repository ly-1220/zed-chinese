...
pub use workspace_settings::{
    ...
    UiLanguage, WorkspaceSettings,
};

pub fn localized_string(language: UiLanguage, english: &'static str) -> &'static str {
    match language {
        UiLanguage::System => english,
        UiLanguage::ZhCn => match english {
            "Cancel" => "取消",
            "Save" => "保存",
            "Save all" => "全部保存",
            "Discard all" => "全部放弃",
            ...
            "Zoom Out" => "缩小",
            "Unlock File" => "解锁文件",
            "This will make this file editable" => "这会让该文件可编辑",
            "Locked File" => "文件已锁定",
            "This file is read-only" => "该文件是只读的",
            "Unpin Tab" => "取消固定标签页",
            "Close Tab" => "关闭标签页",
            "Read-Only File" => "只读文件",
            ...
            "Close All" => "关闭全部",
            "Pin Tab" => "固定标签页",
            "Make File Read-Only" => "设为只读文件",
            "Make File Editable" => "设为可编辑文件",
            "Copy Path" => "复制路径",
            ...
            "Next Hunk" => "下一个修改块",
            "Previous Hunk" => "上一个修改块",
            "Move Line Up" => "上移当前行",
            "Move Line Down" => "下移当前行",
            "Duplicate Selection" => "复制所选内容",
            "View" => "视图",
            "Reset Zoom" => "重置缩放",
            "Reset All Zoom" => "重置全部缩放",
            ...
            "Evaluate Selection" => "执行选中的表达式",
            "Go to Implementation" => "转到实现",
            "Rename Symbol" => "重命名符号",
            "Format Buffer" => "格式化缓冲区",
            "Format Selections" => "格式化选中内容",
            "Show Code Actions" => "显示代码操作",
            "Add to Agent Thread" => "添加到智能体线程",
            ...
            "Copy Permalink to Line" => "复制永久链接到行",
            // Project Panel
            "Search Inside" => "在内部搜索",
            "New Folder" => "新建文件夹",
            ...
            "Restore File" => "恢复文件",
            "Collapse All" => "全部折叠",
            "Add Project to Workspace…" => "将项目添加到工作区…",
            // Git Panel
            "Stage All" => "全部暂存",
            "Unstage All" => "全部取消暂存",
            "Stash All" => "全部储藏",
            ...
            "View Stash" => "查看储藏",
            "Open Diff" => "打开差异对比",
            "Discard Tracked Changes" => "放弃跟踪的更改",
            "Trash Untracked Files" => "删除未跟踪的文件",
            "Tree View" => "树形视图",
            "Flat View" => "平铺视图",
            "Sort by Path" => "按路径排序",
            ...
            "Edit Hit Condition Breakpoint" => "编辑命中条件断点",
            "Set Hit Condition Breakpoint" => "设置命中条件断点",
            "Enable" => "启用",
            "Disable" => "禁用",
            // Services menu
            "Services" => "服务",
            ...
            // Title Bar
            "Keymap" => "键位映射",
            // Title Bar / Edit Prediction / Notifications
            "Sign Out" => "退出登录",
            "Restart" => "重启",
            ...
            "Project Name" => "项目名称",
            "The displayed name of this project. If left empty, the root directory name will be displayed." => "此项目的显示名称。如果留空，将显示根目录名称。",
            "When Closing With No Tabs" => "当无标签页时关闭",
            "What to do when using the 'close active item' action with no tabs." => "当没有标签页时使用'关闭活动项'操作的行为。",
            "On Last Window Closed" => "当最后一个窗口关闭时",
            "What to do when the last window is closed." => "当最后一个窗口关闭时的行为。",
            "Use System Path Prompts" => "使用系统路径提示",
            "Use native OS dialogs for 'Open' and 'Save As'." => "使用原生操作系统对话框进行'打开'和'另存为'。",
            "Use System Prompts" => "使用系统提示",
            "Use native OS dialogs for confirmations." => "使用原生操作系统对话框进行确认。",
            "UI Language" => "界面语言",
            "The language to use for Zed's built-in UI strings." => "用于 Zed 内置界面字符串的语言。",
            // Agent UI / Sidebar
            "Token limit reached" => "已达到令牌限制",
            "Token limit is close to exhaustion" => "令牌限制即将耗尽",
            "View Details" => "查看详情",
            "Error" => "错误",
            "Collapse Displayed Threads" => "折叠显示的线程",
            "Activate Workspace" => "激活工作区",
            "New Thread" => "新建线程",
